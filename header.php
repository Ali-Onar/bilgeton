                ...
                <nav id="navigation" class="navigation navigation-landscape">
                    <div class="nav-header">
                        <a class="nav-brand" href="#">
                            <img src="assets/img/logo5.jpg" class="logo" alt="" />
                        </a>
                            ...
                            <div class="Reveal-search-content">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-5 col-sm-12 br-left-p">
                                        <div class="form-group">
                                            <div class="input-with-icon">
                                                <input type="text" class="form-control" placeholder="Aranacak kelimeni yaz...">
                                                <i class="ti-search"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12">
                                        <div class="form-group">
                                            <a href="#" class="btn search-btn btn-black">Ara</a>
                                        </div>
                                    </div>

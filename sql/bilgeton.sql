...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 06 Nis 2021, 01:40:17
...
(26, 'test49', 'test49', '606b9c4e05e07.jpg', 'test49', 'e10adc3949ba59abbe56e057f20f883e', '1', 0);
...
CREATE TABLE `category` (
  ...
  `category_slug` varchar(100) COLLATE utf8_turkish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_turkish_ci;
...
INSERT INTO `category` (`category_id`, `category_name`, `category_icon`, `category_status`, `category_highlight`, `category_slug`) VALUES
(1, 'Edebiyat', 'lni lni-library', '1', '0', 'edebiyat'),
(2, 'Bilim', 'lni lni-cloud-check', '1', '0', 'bilim'),
(3, 'Yazılım', 'lni lni-database', '1', '0', 'yazilim'),
(4, 'Mühendislik', 'lni lni-certificate', '1', '0', 'muhendislik'),
(5, 'YKS', 'lni lni-book', '1', '0', 'yks'),
(6, 'Türk Tarihi', 'lni lni-shield', '1', '0', 'turk-tarihi'),
(15, 'OOP', 'lni lni-clipboard', '1', '1', 'oop');
...
(10, 'Adres', 'address', 'Bilgeton', 'textarea', 0, '0', '1'),
...
(14, 'Copyright Footer', 'copyright', '© 2021 Bilgeton. Designed By <a target=\"_blank\" href=\"https://www.linkedin.com/in/ali-tunacan-onar/\">Ali Onar</a>', 'text', 0, '', ''),
(15, 'Sosyal Facebook', 'facebook', 'https://www.facebook.com/ali.onar.33/', 'text', 0, '0', '1'),
(16, 'Sosyal Twitter', 'twitter', 'https://twitter.com/alitncn', 'text', 0, '0', '1'),
(17, 'Sosyal İnstagram', 'instagram', 'https://www.instagram.com/alionar60', 'text', 0, '0', '1');
...
(44, 'Kader Altıntaş', '', 'kader-altintas', '', '', '', 'kader@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '1', 0, '', '', '', ''),
(45, 'akif', '', '', '', '', '6067b57f251d4.png', 'hasimo@a.com', 'e10adc3949ba59abbe56e057f20f883e', '1', 0, '', '', '', ''),
(46, 'yenitest', '', '', '', '', 'Array', 'yenitest@yenitest.com', '71b4ddec540b046ea4e6514f7ca9de59', '1', 0, '', '', '', ''),
(48, 'test49', '', 'test49', '', '', '', 'test49@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '1', 0, '', '', '', ''),
(49, 'test18', '', 'test18', '', '', '', 'test18@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '1', 0, '', '', '', '');
...
--
ALTER TABLE `admins`
  MODIFY `admins_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- Tablo için AUTO_INCREMENT değeri `blogs`
--
ALTER TABLE `blogs`
  MODIFY `blogs_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

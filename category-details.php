...
$sql = $db->wread("category", "category_slug", $_GET['category_slug']);
                            ...
                            <form method="POST" action="search.php">
                                <div class="form-group">
                                    <div class="input-with-icon">
                                        <input type="text" class="form-control" name="search_name" placeholder="Aranacak kelime">
                                ...
                                <div class="text-center">
                                    <button name="search_blog" class="btn btn-theme btn-md full-width">Arama</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="content-area col-lg-9 col-md-12">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <?php
                        $forBlogscategoryID = $row['category_id'];
                        $sql = $db->qSql(
                            "SELECT blogs.*, users.* FROM blogs INNER JOIN users ON blogs.users_id=users.users_id WHERE category_id=:category_id order by blogs_time DESC",
                            "category_id",
                            $forBlogscategoryID
                        );
